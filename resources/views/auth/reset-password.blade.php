       ...
       <form method="post" action="{{ route('password.store')}}">
        ...
        <input type="hidden" name="token" value="{{ $request->route('token') }}">
            <div class="form-group">
                <input type="email"  name="email" placeholder="Password *" value="{{old('email', $request->email)}}"  required autofocus autocomplete="email"/>
            ...
            <div class="form-group">
                <input type="password"  name="password_confirmation" placeholder="Confirm you password *" required autocomplete="new-password" />
