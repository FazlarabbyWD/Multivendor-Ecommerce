                    ...
                    <div class="row">
                        <div class="heading_s1">
                            <img class="border-radius-15" src="{{ asset('frontend') }}/assets/imgs/page/reset_password.svg"
                                alt="" />
                            <h2 class="mb-15 mt-15">Password Reset Link</h2>
                                ...
                                <div class="padding_eight_all bg-white">
                                    <form method="post" action="{{ route('password.email') }}">
                                        ...
                                        <div class="form-group">
                                            <input type="email" required="" name="email" placeholder="Type you Email Address *" />
                                            <x-input-error :messages="$errors->get('email')" class="mt-2" />
                                        </div>

                                        <div class="form-group">
                                            <button type="submit" class="btn btn-heading btn-block hover-up"
                                                name="login">Reset password Link</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
