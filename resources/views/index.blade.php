        ...
        <ul class="nav flex-column" role="tablist">
            ...
            <li class="nav-item">
               <form action="{{route('user.logout')}}" method="post">
                @csrf
                <button  type="submit" class="nav-link" href=""><i class="fi-rs-sign-out mr-10"></i>Logout</button>
               </form>
            </li>
        </ul>
    </div>
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{route('user.update')}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                              <img id="image_preview" height="150" width="150" src="{{(!empty($userData->profile_pic))? asset('uploads/user/'.$userData->profile_pic):asset('uploads/user/admin.png')}}" alt="">
                            </div>
